...
class TelefonoConSet {
  ...
  set TelefonoConSet(constructor) {
    this.valorMinimo = constructor[0];
    this.valorMaximo = constructor[constructor.length - 1];
  }
}
const telefonoEj16 = new TelefonoConSet(605871234, "pepephone", "Iphone", "13");
function telefonoCreado() {
  document.getElementById("resultado").innerHTML = telefonoEj16.tedaNumero;
}
function telefonoSeteado() {
  document.getElementById("resultado").innerHTML = telefonoEj16.tedaMarca = ["alcatel"];
}
